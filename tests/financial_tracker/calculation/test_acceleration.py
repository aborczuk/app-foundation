...
def test_classifies_acceleration_with_a_finite_materiality_boundary() -> None:
    ...
    assert acceleration.classify_acceleration(Decimal("0.5"), materiality=Decimal("1")) == "stable"
    assert acceleration.classify_acceleration(Decimal("1"), materiality=Decimal("1")) == "accelerating"
    assert acceleration.classify_acceleration(None, materiality=Decimal("1")) == "unavailable"
    assert acceleration.classify_acceleration(Decimal("NaN"), materiality=Decimal("1")) == "unavailable"
    assert acceleration.classify_acceleration(Decimal("1"), materiality=Decimal("-1")) == "unavailable"
