...
feature_id: "031"
task_id: "T016"
task_summary: "Add reranker-daemon transport coverage for shortlist-sized scoring and shared-file fallback in `tests/unit/test_read_code_reranker_daemon.py` and `tests/unit/test_read_code_shortlist.py`"
primary_edit_seam: "scripts/read_code.py:_rerank_semantic_candidates"
related_paths: ["tests/unit/test_read_code_reranker_daemon.py", "tests/unit/test_read_code_shortlist.py", "scripts/read_code.py"]
---

# HUD: T016 - Add reranker-daemon transport coverage for shortlist-sized scoring and shared-file fallback in `tests/unit/test_read_code_reranker_daemon.py` and `tests/unit/test_read_code_shortlist.py`

## Objective

Deliver `T016` so the declared seam satisfies: Add reranker-daemon transport coverage for shortlist-sized scoring and shared-file fallback in `tests/unit/test_read_code_reranker_daemon.py` and `tests/unit/test_read_code_shortlist.py`.
...
- [FILL: write the actual task-local solution for `scripts/read_code.py:_rerank_semantic_candidates`.]
...
- [FILL: describe the exact task-seam behavior expected at `scripts/read_code.py:_rerank_semantic_candidates`.]

## Primary Edit Seam

**File:Symbol**: `scripts/read_code.py:_rerank_semantic_candidates`
