...
feature_id: "031"
task_id: "T024"
task_summary: "Record daemon-vs-local semantic query sourcing in search metadata and preserve scratchpad behavior in `scripts/read_code.py` and `tests/unit/test_read_code_shortlist.py`"
primary_edit_seam: "scripts/read_code.py:_append_search_metadata_event"
related_paths: ["scripts/read_code.py", "tests/unit/test_read_code_shortlist.py"]
---

# HUD: T024 - Record daemon-vs-local semantic query sourcing in search metadata and preserve scratchpad behavior in `scripts/read_code.py` and `tests/unit/test_read_code_shortlist.py`

## Objective

Deliver `T024` so the declared seam satisfies: Record daemon-vs-local semantic query sourcing in search metadata and preserve scratchpad behavior in `scripts/read_code.py` and `tests/unit/test_read_code_shortlist.py`.
...
- [FILL: write the actual task-local solution for `scripts/read_code.py:_append_search_metadata_event`.]
...
- [FILL: describe the exact task-seam behavior expected at `scripts/read_code.py:_append_search_metadata_event`.]

## Primary Edit Seam

**File:Symbol**: `scripts/read_code.py:_append_search_metadata_event`
