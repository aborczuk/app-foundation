...
Deliver `T004` so the declared seam satisfies: Add scoped fast-path regression coverage for exact-symbol and file-local context reads in `tests/unit/test_read_code_shortlist.py` and `tests/unit/test_read_code_index_refresh.py`.
...
- [FILL: write the actual task-local solution for `tests/unit/test_read_code_shortlist.py:_query_semantic_anchor_candidate`.]
...
- [FILL: describe the exact task-seam behavior expected at `tests/unit/test_read_code_shortlist.py:_query_semantic_anchor_candidate`.]
