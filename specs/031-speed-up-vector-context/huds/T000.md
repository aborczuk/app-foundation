...
Deliver `T000` so the declared seam satisfies: Define the accepted scoped, broad, and markdown benchmark corpus in `specs/031-speed-up-vector-context/tasks.md` and `specs/031-speed-up-vector-context/plan.md`.
...
- [FILL: write the actual task-local solution for `specs/031-speed-up-vector-context/plan.md:Research Baseline`.]
...
- [FILL: describe the exact task-seam behavior expected at `specs/031-speed-up-vector-context/plan.md:Research Baseline`.]
