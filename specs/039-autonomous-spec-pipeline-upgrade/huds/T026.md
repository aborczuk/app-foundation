...
feature_id: "039"
task_id: "T026"
task_summary: "Add live pinned-engine verification in tests/integration/test_speckit_workflow_live.py covering prompt bootstrap, command validation, bounded repair, pause/resume, crash recovery, handoff convergence, and terminal reconciliation."
story_id: "US5"
primary_edit_seam: null
related_paths: []
---

# HUD: T026 - Add live pinned-engine verification in tests/integration/test_speckit_workflow_live.py covering prompt bootstrap, command validation, bounded repair, pause/resume, crash recovery, handoff convergence, and terminal reconciliation.

## Objective

Deliver `T026` so the task scope satisfies: Add live pinned-engine verification in tests/integration/test_speckit_workflow_live.py covering prompt bootstrap, command validation, bounded repair, pause/resume, crash recovery, handoff convergence, and terminal reconciliation..
...
- [ ] [FILL: acceptance for `US5` translated into task-local completion criteria.]
