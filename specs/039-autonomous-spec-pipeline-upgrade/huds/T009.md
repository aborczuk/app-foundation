...
feature_id: "039"
task_id: "T009"
task_summary: "Implement scripts/speckit_command_adapter.py with allowlisted executable/argv contracts, root cwd, validated input schema, timeout, output cap, redaction, permission class, and JSON stdout envelope."
story_id: "US2"
primary_edit_seam: null
related_paths: []
---

# HUD: T009 - Implement scripts/speckit_command_adapter.py with allowlisted executable/argv contracts, root cwd, validated input schema, timeout, output cap, redaction, permission class, and JSON stdout envelope.

## Objective

Deliver `T009` so the task scope satisfies: Implement scripts/speckit_command_adapter.py with allowlisted executable/argv contracts, root cwd, validated input schema, timeout, output cap, redaction, permission class, and JSON stdout envelope..
