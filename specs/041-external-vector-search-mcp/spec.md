...
**Created**: [DATE]
**Status**: Draft
**Input**: User description: "Replace the internal read-code embedding and context search implementation with bobmatnyc/mcp-vector-search as an MCP-managed vector search service. CodeGraph remains unchanged and should continue to run after vector search plus the new BM25 path."
