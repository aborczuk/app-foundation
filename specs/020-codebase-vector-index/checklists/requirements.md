# Specification Quality Checklist: Codebase Vector Index
...
- Adopted dependencies verified on PyPI: chromadb 1.5.7, tree-sitter 0.25.2, watchdog 6.0.0 (2026-04-11)
- Auth/permission failure acceptance criterion marked N/A: feature is a local file indexing tool with no authentication boundary
- Venue-constrained entities: N/A (no external live-data integrations)
- External state drift: N/A (purely local index against local files)
