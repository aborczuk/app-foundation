...
| `storage_path` | string | Yes | Stable on-disk path | Location of the active vector collection under `.codegraphcontext/global/db/vector-index/`. |
...
- **Primary storage**: On-disk Chroma collection under `.codegraphcontext/global/db/vector-index/`
