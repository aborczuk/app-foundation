...
| T012 | 2 | Wire coverage validator into governance checks in scripts/validate_doc_graph.py:run_validators and scripts/validate_constitution_sync.py:run_checks | Bounded single-scope change using existing patterns. |
