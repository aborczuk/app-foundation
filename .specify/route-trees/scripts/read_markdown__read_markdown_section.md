...
generated_at: "2026-04-16T16:22:40Z"
---

# Route Tree: read_markdown.read_markdown_section (script)
...
4. **Implementation lookup**: read `scripts/read_markdown.py` when you need to inspect or modify the underlying logic.
